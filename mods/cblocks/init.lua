...
for i = 1, #colours do
	...
	doors.register("cblocks:door_wood_" .. colours[i][1], {
		tiles = {{ name = "doors_door_wood.png^[colorize:" .. colours[i][3], backface_culling = true }},
		description = colours[i][2] .. " Wooden Door",
		inventory_image = "doors_item_wood.png^[colorize:" .. colours[i][3],
	...
	doors.register("cblocks:door_steel_" .. colours[i][1], {
		tiles = {{name = "doors_door_steel.png^[colorize:" .. colours[i][3], backface_culling = true}},
		description = colours[i][2] .. " Steel Door",
		inventory_image = "doors_item_steel.png^[colorize:" .. colours[i][3],
		protected = true,
