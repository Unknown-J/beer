...
local enviro_update_form = function (pos)
	...
	]]):format(x0, y0, z0, r, speed, jump, g, sneak, list_name, list_name))
end
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		elseif fields.help then
			local text = "VALUES\n\n" ..
				...
				"Gravity:  [0.1, 40\\]\n" ..
				"Sneak:   [0, 	    1\\]"
			local form = "size[6,7]textarea[0,0;6.5,8.5;envirohelp;ENVIRONMENT MODIFICATIONS;" .. text .. "]"
			minetest.show_formspec(name, "basic_machines:envirohelp", form)
		end
	end,
