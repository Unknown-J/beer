   ...
   local time = name == minetest.settings:get("name") and 0 or 2
	...
	minetest.after(time, function(player, pos, target_pos)
		if player then
			...
			if node2 and node2.name ~= "ignore" and node2.name ~= "travelnet:travelnet" and node2.name ~= "travelnet:elevator" and node2.name ~= "locked_travelnet:travelnet" and node2.name ~= "travelnet:travelnet_private" then
