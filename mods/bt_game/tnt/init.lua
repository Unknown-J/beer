...
local toughNodes = {
	[minetest.get_content_id("protector:protect")] = true,
	[minetest.get_content_id("protector:protect2")] = true,
	[minetest.get_content_id("protector:chest")] = true,
	[minetest.get_content_id("protector:door_wood_b_1")] = true,
	[minetest.get_content_id("protector:door_wood_t_1")] = true,
	[minetest.get_content_id("protector:door_wood_b_2")] = true,
	[minetest.get_content_id("protector:door_wood_t_2")] = true,
	[minetest.get_content_id("protector:door_steel_b_1")] = true,
	[minetest.get_content_id("protector:door_steel_t_1")] = true,
	[minetest.get_content_id("protector:door_steel_b_2")] = true,
	[minetest.get_content_id("protector:door_steel_t_2")] = true,
